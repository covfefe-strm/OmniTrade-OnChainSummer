...
async function main() {
  ...
  let amountOfGas = 100000; // total amoutn of gas for execution on destination chain
  let postHookGas = 80000; // amount of gas for post hook transaction execution
  ...
  const recipientPayload = abiCoder.encode(["address"], [devAddress]);
